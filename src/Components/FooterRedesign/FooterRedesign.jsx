    ...
    <div className="footer-container">
      <div className="footer-top">
        ...
        <div className="footer-contact">
          <span>Contact us:<br/></span><span className="email">info@mentorhints.com</span>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-icons">
          <img src={facebook} alt="" /><img src={instagram} alt="" /><img src={linkedin} alt="" /><img src={twitter} alt="" />
        </div>
      </div>
    </div>
    </div>
